...
//        tabStatus = findViewById(R.id.tabStatus);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.logout100) {
            ...
            e.clear();
            e.apply();
            startActivity(new Intent(getApplication(), Signinnurse.class).setFlags(Intent.FLAG_ACTIVITY_NO_HISTORY).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
        }
        if(id==R.id.event5) {
           Intent jk=new Intent(MainActivityhome.this,Request.class);
           startActivity(jk);
        }
