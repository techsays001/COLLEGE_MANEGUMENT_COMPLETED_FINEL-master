...
//                    data.put("lo", sh.getString("lo",null));
                    ...
                    String result = rh.sendPostRequest("https://androidprojectstechsays.000webhostapp.com/College_communication_app/Student_registration.php", data);
