            ...
            if (uph.getText().toString().isEmpty())
              {
               ...
               passok.setError("enter a avlid phone  password");
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/College_communication_app/admin_login.php",
...
//Toast.makeText(Signin.this, response, Toast.LENGTH_LONG).show();
                              ...
                              passok.getText().clear();
                                ...
                                if(response.contains("no"))
                                {
                                    ...
                                    new SweetAlertDialog(Signinnurse.this, SweetAlertDialog.WARNING_TYPE)
                                            .setTitleText("Enter valid user name or passwored")
